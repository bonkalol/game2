...
var Content = (function () {
	...
	_createClass(Content, [{
		...
		value: function assign() {
			...
			Object.keys(this.content).forEach(function (key) {
				if (App.data.rubrics.includes(key)) {
					_this.inGame[key] = _this.content[key];
				}
			});
			this.merge();
			this.filters();
		...
		value: function filters() {
			...
			Object.keys(this.inGame).forEach(function (key) {
				_this2.inGame[key].forEach(function (question, i) {
					Object.keys(_this2.filters).forEach(function (filterType) {
